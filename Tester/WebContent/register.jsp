...
<body>
	<div class="container">
		...
		<form class="form-horizontal" action="registerServlet" method="post"
			...
			<div class="form-group">
				<label class="control-label col-sm-2" for="text">Store
					Credit:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="stc"
						name="store_credit" placeholder="Enter credit">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="text">Credit
					Card:</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="card"
						name="credit_card_info" placeholder="Enter card number">
				</div>
			</div>
			<div class="form-group">
